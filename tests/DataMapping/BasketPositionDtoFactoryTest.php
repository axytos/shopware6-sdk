...
class BasketPositionDtoFactoryTest extends TestCase
{
    ...
    private BasketPositionDtoFactory $sut;
    ...
    public function setUp(): void
    {
        ...
        $this->sut = new BasketPositionDtoFactory(
    ...
    public function test_create_calulates_product_name(): void
    {
        $orderLineItem = $this->createOrderLineItemEntity();
    ...
    private function createOrderLineItemEntity(): OrderLineItemEntity
    {
