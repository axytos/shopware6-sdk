...
class PaymentControlBasketDtoFactoryTest extends TestCase
{
    /** @var PaymentControlBasketPositionDtoCollectionFactory&MockObject */
    private PaymentControlBasketPositionDtoCollectionFactory $basketPositionDtoCollectionFactory;

    private PaymentControlBasketDtoFactory $sut;

    public function setUp(): void
    {
        $this->basketPositionDtoCollectionFactory = $this->createMock(PaymentControlBasketPositionDtoCollectionFactory::class);

        $this->sut = new PaymentControlBasketDtoFactory(
    ...
    public function test_create_maps_order_line_items_as_positions(): void
    {
        ...
        /** @var PaymentControlBasketPositionDtoCollection&MockObject */
        $basketPositions = $this->createMock(PaymentControlBasketPositionDtoCollection::class);
